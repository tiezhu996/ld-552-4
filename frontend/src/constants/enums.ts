...
export const statusText: Record<string, string> = { DRAFT: '草稿', OPEN: '开放', PAUSED: '暂停', CLOSED: '关闭', ARCHIVED: '归档', SUBMITTED: '已投递', SCREENING: '筛选中', SHORTLISTED: '候选池', INTERVIEWING: '面试中', OFFERED: 'Offer 阶段', HIRED: '已入职', REJECTED: '已拒绝', PASS: '通过', FAIL: '未通过', PENDING: '待反馈', APPROVED: '已审批', SENT: '已发送', ACCEPTED: '已接受', WITHDRAWN: '已撤回', PHONE: '电话', EMAIL: '邮件', WECHAT: '微信', ONSITE: '现场', VIDEO: '视频', OTHER: '其他', TECHNICAL: '技术面' };
